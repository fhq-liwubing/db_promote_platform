<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" prop="companyName" label="公司名称" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="provinces" label="省份" style="width: 60px;"> </el-table-column>
      <el-table-column align="center" prop="city" label="城市" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="accName" label="联系人姓名" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="phone" label="手机号" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="addr" label="公司地址" style="width: 60px;"></el-table-column>
       <el-table-column align="center" prop="mail" label="邮箱" style="width: 60px;"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      showUpdate($index) {
        ...
        this.tempArticle.content = this.list[$index].business;
