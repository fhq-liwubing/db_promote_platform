<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" prop="f_acc_name" label="任务数量" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="f_phone" label="任务总数量" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="f_phone" label="已完成" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="f_phone" label="完成度" style="width: 60px;"></el-table-column>
