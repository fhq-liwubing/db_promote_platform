<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
            <el-form-item label="联系人姓名">
              <el-input  placeholder="联系人姓名" v-model="listQuery.name"></el-input>
            </el-form-item>
        <el-form-item>
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" prop="name" label="联系人姓名" style="width: 60px;"></el-table-column>
      <el-table-column align="center" prop="phoneNo" label="手机号" style="width: 60px;"> </el-table-column>
      <el-table-column align="center" prop="phoneNo" label="地址" style="width: 60px;"> </el-table-column>
      <el-table-column align="center" prop="phoneNo" label="公司名称" style="width: 60px;"> </el-table-column>
      <el-table-column align="center" prop="email" label="备注" style="width: 60px;"></el-table-column>
